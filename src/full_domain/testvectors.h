...
void get_x_power_f_m(seal::Ciphertext ct_m, int nb_bits, seal::Plaintext T[], seal::Ciphertext &dest, seal::EncryptionParameters parms, seal::GaloisKeys galois_keys, seal::RelinKeys relin_keys, int N_inverse, seal::SEALContext& context, seal::Evaluator& evaluator);
int inverse_modulus(int a, int b);
std::string dec2binstr(int a, int nb_bits);
void get_testvectors(seal::EncryptionParameters parms, char xy, int nb_bits, int max, seal::Plaintext T_plain[], int base_cell, int height_cell, int max_y); 
